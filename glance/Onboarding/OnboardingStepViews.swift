...
struct PermissionsStepView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            PermissionRow(
                title: "Accessibility",
                detail: "Allow Peek to unlock your Mac",
                granted: controller.accessibilityGranted
            ) { controller.grantAccessibility() }

            PermissionRow(
                title: "Camera",
                detail: "Allow Peek to recognize your face",
...
struct SecurityNoticeStepView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("Peek is not as secure as Apple's FaceID or TouchID.")
                .font(GlanceTheme.Font.title)
                .foregroundStyle(GlanceTheme.textPrimary)
...
struct PasswordStepView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("Your password is required to unlock your Mac. It is encrypted and securely stored on your device. Peek works entirely offline, so your password never leaves your Mac.")
                .font(GlanceTheme.Font.passwordCaption)
                .foregroundStyle(GlanceTheme.textSecondary)
                .fixedSize(horizontal: false, vertical: true)
                .padding(.leading, 4)
