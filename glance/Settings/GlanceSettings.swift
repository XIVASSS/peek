...
final class GlanceSettings {
    ...
    private enum Key {
        static let isFaceUnlockEnabled = "PeekSettings.isFaceUnlockEnabled"
        static let matchThreshold = "PeekSettings.matchThreshold"
        static let livenessChecksEnabled = "PeekSettings.livenessChecksEnabled"
        static let livenessMode = "PeekSettings.livenessMode"
        static let minimumFaceWidth = "PeekSettings.minimumFaceWidth"
        static let unlockAnimationStyle = "PeekSettings.unlockAnimationStyle"
        static let showUnlockAnimation = "PeekSettings.showUnlockAnimation"
        /// Legacy bool key — read once during migration, then ignored.
        static let playUnlockAnimation = "PeekSettings.playUnlockAnimation"
        static let unlockTriggers = "PeekSettings.unlockTriggers"
        static let retryOnHover = "PeekSettings.retryOnHover"
        static let faceDetectionSeconds = "PeekSettings.faceDetectionSeconds"
        static let autoRetryOnce = "PeekSettings.autoRetryOnce"
        static let hapticFeedbackEnabled = "PeekSettings.hapticFeedbackEnabled"
        static let preferredDisplayID = "PeekSettings.preferredDisplayID"
        static let preferredDisplayName = "PeekSettings.preferredDisplayName"
        static let autoLockIntervalDays = "PeekSettings.autoLockIntervalDays"
        static let defaultCameraID = "PeekSettings.defaultCameraID"
        static let builtInDisplayCameraID = "PeekSettings.builtInDisplayCameraID"
        static let externalDisplayCameraID = "PeekSettings.externalDisplayCameraID"
        static let hasCompletedOnboarding = "PeekSettings.hasCompletedOnboarding"
        static let onboardingResumeStep = "PeekSettings.onboardingResumeStep"
        static let hasAcknowledgedSecurityNotice = "PeekSettings.hasAcknowledgedSecurityNotice"
    }
