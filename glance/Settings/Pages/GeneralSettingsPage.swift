...
struct GeneralSettingsPage: View {
    ...
    private func inputMonitoringNotice() -> some View {
        VStack(alignment: .leading, spacing: 6) {
            SettingsCaption(text: "“On space” reads the keyboard directly to see the space key on the lock screen, which needs Accessibility — the same permission Peek uses to type your password. Switch Peek on under Privacy & Security → Accessibility, then quit and reopen Peek.")
