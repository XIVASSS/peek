            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                SettingsGroup {
                    SettingsRowContent(
                        ...
                        info: "Hardened fork defaults to Heavy: glare, device bezel, photo/screen texture, plus proof of real 3D depth (blink or head turn)."
                    ) {
