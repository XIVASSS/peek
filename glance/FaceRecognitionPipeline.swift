...
extension FaceRecognitionPipeline {
    ...
    nonisolated func score(
        ...
        liveGeometry: FaceGeometryDescriptor? = nil
    ) -> [ScoredIdentity] {
        identities.compactMap { identity in
            ...
            return ScoredIdentity(
                ...
                maxSampleSimilarity: maxSim,
                geometrySimilarity: geometrySim
            )
    ...
    nonisolated func bestMatch(
        ...
        threshold: Float,
        geometryThreshold: Float = FaceRecognitionPipeline.defaultGeometryThreshold,
        requireGeometryWhenAvailable: Bool = true
    ) -> ScoredIdentity? {
