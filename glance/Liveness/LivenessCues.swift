...
struct LivenessTuning: Equatable {
    ...
    /// Passive texture PAD — fire when spoofScore is clearly elevated across a few frames.
...
nonisolated enum LivenessCues {
    ...
    /// Moire / uniform-sharpness / banding from `PassiveAntiSpoof`.
    nonisolated static func passiveSpoof(_ frame: LivenessFrame?) -> CueReading {
